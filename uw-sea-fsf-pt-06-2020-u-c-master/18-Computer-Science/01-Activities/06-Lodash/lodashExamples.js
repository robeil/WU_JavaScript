...
console.log("_.uniq");
let dupeArray = [1, 2, 2, 1, 4, 6, 2, 9, 10, 10, 1, 6];
console.log("Original array:", dupeArray);
let uniqueArray = _.uniq(dupeArray);
...
console.log("Original array:", uniqueArray);
let shuffledArray = _.shuffle(uniqueArray);
...
// as you would expect. Instead it just creates another letiable thats pointing to the same object in memory.
// Any changes made to one object affects another

// _.clone attempts to solve this
// Before clone
console.log("Without using _.clone:");
let originalPerson = { name: "Sarah", age: 22 };
let samePerson = originalPerson;
samePerson.age = 25;
...
let clonedPerson = _.clone(originalPerson);
